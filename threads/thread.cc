...
//----------------------------------------------------------------------
int waitingProcessSpaceId,waitingThreadExitCode;
//
// #ifdef USER_PROGRAM
// void
// Thread::Terminated ()
...
Thread::Finish ()
{
    ...
    // {
    //     waitingThread = (Thread *)waitingList->getltem(i);
    //     if(currentThread->UserProgramId == waitingThread->waitingProcessSapceId)
    //     {
